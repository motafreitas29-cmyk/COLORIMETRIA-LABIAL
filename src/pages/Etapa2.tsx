  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0d0a0a] via-[#1a080d] to-[#0d0a0a] text-white flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full mx-auto">
        ...
        <div className="bg-[#1a080d] border border-[#C4424A]/20 rounded-2xl p-6 mb-8 text-[#d0c8b8] text-base sm:text-lg leading-relaxed space-y-4">
          ...
          <div className="border-t border-[#C4424A]/20 pt-4">
            ...
            <p className="text-white font-bold text-xl mt-2">É entender a teoria das cores aplicada ao lábio.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
          {[
            ...
            <div key={i} className="bg-[#C4424A]/10 border border-[#C4424A]/30 rounded-xl p-4 text-center">
              ...
              <p className="text-white text-base font-semibold">{item.text}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <button
            onClick={onNext}
            className="w-full bg-gradient-to-r from-[#C4424A] to-[#E8A87C] text-white font-black py-5 px-8 rounded-full text-xl hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(196,66,74,0.4)]"
          >
